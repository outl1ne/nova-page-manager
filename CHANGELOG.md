...
- Fix undefined $this->resource->published sytanx used in updateRules.
...
- Boolean error when using postgres database
...
- Added `NovaDependencyContainer` support
...
- Added `parent_id` to `nova_get_pages_structure_flat` helper function.

## [3.2.3] - 2020-11-17

### Changed

- Fixed creationRules for region
...
- Fixed migration crashing due to Exception use

## [3.1.8] - 2020-10-28

### Changed

- Fixed NovaLang references

## [3.1.7] - 2020-10-28

### Changed

- Fixed raw SQL in migration that only worked on MySQL and MariaDB
